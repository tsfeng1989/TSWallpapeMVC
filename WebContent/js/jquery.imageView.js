				...
				if (settings['loading']) {
					...
					if ($img.data('state') == 0) {
						...
						/*if ($.browser.mozilla){
							...
							$('#picture-details').css('max-width','');
							$('#picture-details').css('max-height','');
							$('#picture-details').css('top','0px');
							$('#picture-details').css('left','0px');
							$('#picture-details').css('position','');
						/*}*/
					}
					else {
						$container.css('cursor', 'move'); 
						$('#picture-details').css('max-width','none ');
						$('#picture-details').css('max-height','none');
						$('#picture-details').css('position','absolute');
					}
				}
			}
